...
// Nota de atribución: el modo Square y la base de ArcadeOutputs parten de aportaciones/mejoras de Suegrini, posteriormente integradas, corregidas y ampliadas en Gunmote por Gustavo A. Lara.
// -----------------------------------------------------------------------------
...
{
    /// <summary>
    /// Calcula la posición del puntero de Gunmote a partir de los LEDs IR, la calibración y el modo de lightbar activo.
    /// </summary>
    public class ScreenPositionCalculator
    {
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a NormalizeAngle.
        /// </summary>
        ...
        private void recalculateLightgunCoordBounds()
        {
            ...
            if (Settings.Default.pointer_4IRMode == "diamond")
            {
                double activeWidth = bottomRightPt.X - topLeftPt.X;
                double activeHeight = bottomRightPt.Y - topLeftPt.Y;

																																					   
																																					   

                boundsX = Math.Abs(activeWidth) > double.Epsilon
                    ? 1.0 / activeWidth
                    : 0.0;

                boundsY = Math.Abs(activeHeight) > double.Epsilon
                    ? 1.0 / activeHeight
                    : 0.0;
            }
            ...
            else if (Settings.Default.pointer_4IRMode == "diamond")
            {
                ...
                if (hasIdealGeometry && (foundCount == 3 || (foundCount == 2 && seenFlags != 0)))
                {
                    ...
                    else if (foundCount == 2)
                    {
                        ...
                        if (isAdjacent)
                        {
                            // --- PASO A: Reconstrucción por Vectores  ---
                            if (seenFlags == 3)
        ...
        /// <summary>
        /// Establece o aplica la relación de aspecto objetivo para limitar correctamente el área activa del puntero.
        /// </summary>
        ...
        /// <summary>
        /// Aplica la compensación de rotación del Wiimote para mantener coherentes los puntos de calibración.
        /// </summary>
    ...
    /// <summary>
    /// Implementa la lógica específica de Gunmote asociada a MathF.
    /// </summary>
