...
namespace WiiTUIO.Provider
{
    ...
    /// <summary>
    /// Implementa la lógica específica de Gunmote asociada a WiiKeyMapper.
    /// </summary>
    public class WiiKeyMapper
    {
        ...
        private System.Windows.Point? savedMousePosition = null;
        private bool mouseMovedForOverlay = false;
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a WiiKeyMapper.
        /// </summary>
        ...
        public WiiKeyMapper(Wiimote wiimote, int wiimoteID, HandlerFactory handlerFactory, string serial = null)
        {
            ...
            // aplicar el keymap por defecto SOLO al arranque
            if (this.defaultKeymap != null && !string.IsNullOrWhiteSpace(this.defaultKeymap.Filename))
            {
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a loadApplicationsJSON.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a keymapConfigWindow_OnConfigChanged.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a SwitchToFallback.
        /// </summary>
        ...
        void homeButtonTimer_Elapsed(object sender, ElapsedEventArgs e)
        {
            ...
            else if (isButtonPressed(ButtonFlag.Home) && !CalibrationOverlay.Current.OverlayIsOn())
            {
                //this.setKeymap(this.defaultKeymap);
                this.MoveMouseAwayForLayoutOverlay();
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a CheckAppKeymap.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a keymapRequested.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a keyMap_onConfigChanged.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a keyMap_onRumble.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a keyMap_onLED.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a keyMap_onSpeaker.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a SendConfigChangedEvt.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a loadKeyMap.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a OnExtensionChanged.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a ToggleIRTracking.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a MoveMouseAwayForLayoutOverlay.
        /// </summary>
        public void MoveMouseAwayForLayoutOverlay()
        {
            try
            {
                savedMousePosition = new System.Windows.Point(
                    System.Windows.Forms.Cursor.Position.X,
                    System.Windows.Forms.Cursor.Position.Y
                );

                mouseMovedForOverlay = true;

                // Manda el cursor a una esquina
                System.Windows.Forms.Cursor.Position = new System.Drawing.Point(0, 0);
            }
            catch
            {
                mouseMovedForOverlay = false;
                savedMousePosition = null;
            }
        }
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a RestoreMouseAfterLayoutOverlay.
        /// </summary>
        public void RestoreMouseAfterLayoutOverlay()
        {
            if (!mouseMovedForOverlay || savedMousePosition == null)
                return;

            try
            {
                System.Windows.Forms.Cursor.Position = new System.Drawing.Point(
                    (int)savedMousePosition.Value.X,
                    (int)savedMousePosition.Value.Y
                );
            }
            catch
            {
