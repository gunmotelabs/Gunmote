...
namespace WiiTUIO.Filters {
    /// <summary>
    /// Implementa la lógica específica de Gunmote asociada a CircularBufferEnum.
    /// </summary>
    class CircularBufferEnum<T> : IEnumerator<T>, IEnumerator {
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a MoveNext.
        /// </summary>
    ...
    class CircularBuffer<T> : IList<T>, ICollection<T>, IEnumerable<T>, ICollection, IEnumerable {
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a CircularBuffer.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a Contains.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a CopyTo.
        /// </summary>
        ...
        /// <summary>
        /// Implementa la lógica específica de Gunmote asociada a IndexOf.
        /// </summary>
